...
The request should provide the source PDF path or paths to extract from.
...
1. **Run the `content-qa` skill** as a separate validation pass, either in the current context or
...
Final summary:
- **Before**: X of the configured corpus buildable
- **After**: Y of the configured corpus buildable
