...
argument-hint: [tier|content-ids...]
---

# Verify Content Against the SRD

The `extract-*` skills **add** content. This skill **audits** content that already exists,
by diffing it against the SRD mirror. It exists because extraction reliably captures level
tables and reliably misses prose sections — a 2026-07 audit found 13 of 16 prestige classes
missing their entire `Requirements` block while every numeric field was correct.
...
1. **Drivers (~48)** — classes and racial HD. Tabular ground truth, and an error here affects
   every character using that class. *Completed 2026-07-27.*
...
Two false-positive traps caught real agents in the last run:
...
silently dropping it or approximating. See [TODO.md](../../../TODO.md) §2 for the known gaps.
