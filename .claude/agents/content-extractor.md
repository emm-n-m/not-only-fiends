...
`$ARGUMENTS` should contain the PDF path and optionally specific content types or page ranges.
...
2. **Delegate to the content-qa agent** for cross-reference validation
...
- IDs follow the established prefix conventions (see CLAUDE.md)
